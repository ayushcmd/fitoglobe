    ...
    <div style={{ minHeight:"100vh", background:C.bg, display:"flex", alignItems:"center", justifyContent:"center", padding:24 }}>
      <div className="fade-up" style={{ width:"100%", maxWidth:400 }}>
        ...
        <Card>
          ...
          {mode !== "forgot" && (
            <>
              <button onClick={() => { setError(""); onAuth(); }} style={{ width:"100%", padding:"13px 20px", background:C.card, border:`1px solid ${C.borderHi}`, borderRadius:12, color:C.text, fontFamily:"DM Sans", fontWeight:600, fontSize:15, cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", gap:10, marginBottom:0 }}
